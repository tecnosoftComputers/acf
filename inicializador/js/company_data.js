$(document).ready(function(){
	...
	$('#addForm').submit(function(e){
		...
		$.ajax({
			method: 'POST',
			url: '../../../controlador/c_company/company_add.php',
			data: addform,
			dataType: 'json',
	...
	$('#editForm').submit(function(e){
		...
		$.ajax({
			method: 'POST',
			url: '../../../controlador/c_company_data/edit.php',
			data: editform,
			dataType: 'json',
			success: function(response){
				if(response.error){
	...
	$('.id').click(function(){
		...
		$.ajax({
			method: 'POST', 
			url: '../../../controlador/c_company_data/delete.php',
			data: {id:id},
			dataType: 'json',
			success: function(response){
				if(response.error){
...
function fetch(){
	$.ajax({
		method: 'POST',
		url: '../../../controlador/c_company/company_fetch.php',
		success: function(response){
			$('#tbody').html(response);
		}
	});
...
function getDetails(id){
	$.ajax({
		method: 'POST',
		url: '../../../controlador/c_company_data/fetch_row.php',
		data: {id:id},
		dataType: 'json',
		success: function(response){
			if(response.error){
