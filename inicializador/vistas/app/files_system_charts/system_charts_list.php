...
<div id="page-wrapper"><br />
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> System Charts</li>
      </ol>
    </nav>

    <div class="row">
        <div class="col-md-6" style="margin-top: -20px"><h2><i class="fa fa-user"></i> System Charts</h2></div>
        <div class="col-md-6">
...
<?php
	if (isset($_POST['update'])) {
	   require_once ("../../../controlador/c_company_users/act_users.php");
    }
?>

<?php
	if (isset($_POST['newuser'])) {
	   require_once ("../../../controlador/c_company_users/reg_users.php");
    }
?>
...
<!--FIN   FORMULARIO PARA EL REGISTRO-->
 ...
 <div class="row">
    ...
    <div class="col-lg-8">
        <input style="background-color: #fcd1ff59" class="form-control" type="text" placeholder="Busca por cédula, nombres, celular, correo.." id="bs-prod"/><br>
...
<div class="panel-body">
    ...
    <form id="formulario" method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                <label> Password</label>
                <input type="text" id="_password" name="passw" class="form-control" />
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                <label> Initial System</label>
                <select id="_initial" name="initial" class="form-control">
                    <option value="?cid=administration/accounting_view">Accounting</option>
                    <option value="?cid=administration/operations_view">Operations</option>
                </select>
            </div>
        </div>
