...
<?php 
    ...
    **********************************************/
    ...
    // Cargar dasbal
        ...
        <script type="text/javascript" src="<?php echo PUERTO.'://'.HOST; ?>/js/files_chart_parameter.js"></script>
                    ...
                    <div class="panel-body">
                        <div class="tab-content"> <!-- Tab panes -->
                            <div class="tab-pane fade in active" id="list-pills"><br />
                                <div class="col-lg-12">
                                    <form id="formulario" action="<?php echo PUERTO.'://'.HOST; ?>/controlador/c_files/add_parameter.php" method="post" class="form-horizontal">
                                        <fieldset>
