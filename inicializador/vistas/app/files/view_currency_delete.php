...
<div class="alert alert-info"><p>Accounting / Files / Currency / Delete  </p></div>
    <div class="row">
        <div class="col-lg-12">
        <div class="col-lg-7">
    ...
    <form action="../../../../controlador/c_files/del_currency.php" method="post" class="form-horizontal">
        <fieldset>
    ...
    <input type="hidden" name="laids" value="<?php echo $idupd ?>">
            <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input maxlength="3" disabled="" autocomplete="off" value="<?php echo $upd_tipo ?>" name="type" type="text" class="form-control input-sm" />
                  </div>
            </div>            
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input autocomplete="off" disabled="" value="<?php echo $upd_nomb ?>" name="name" type="text" class="form-control input-sm" />
                  </div>
            </div>            
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input maxlength="50" disabled="" value="<?php echo $upd_fact ?>" autocomplete="off" name="factor" type="text" class="form-control input-sm" />
                  </div>
            </div>
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input maxlength="3" disabled="" value="<?php echo $upd_simb ?>" autocomplete="off" name="simbol" type="text" class="form-control input-sm" />
                  </div>
            </div>
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input autocomplete="off" disabled="" value="<?php echo $upd_deci ?>" maxlength="4" name="decimal" type="text" class="form-control input-sm" />
                  </div>
            </div>
                

            <div class="modal-footer">
                <button style="float: left;" type="submit" name="register" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-remove"></span> Delete</a></button>&nbsp;
