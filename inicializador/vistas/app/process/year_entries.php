...
<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Accounting / Processes / Year en Entries</p></div>
    <div class="row">
        <div class="col-lg-6">
    <form action="../../../controlador/c_files/add_bank.php" method="post" class="form-horizontal">
        <fieldset>
    <legend class="mibread"><strong>Year en Entries</strong></legend>         

            <div class="form-group">
                  <label class="col-md-4 control-label" for="name">Fecha del cierre contable</label>
                  <div class="col-md-8">
            ...
            <div class="form-group">
                  <label class="col-md-4 control-label" for="name">Detalle del asiento del cierre</label>
                  <div class="col-md-8">
                    <input name="accountycode" type="text" class="form-control input-sm" />
                  </div>
            </div>
            
            <div class="form-group">
                  <label class="col-md-4 control-label" for="name">Asiento N0.</label>
                  <div class="col-md-8">
                    <input name="accountycode" type="text" class="form-control input-sm" />
                  </div>
            </div>          
