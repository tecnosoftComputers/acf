...
<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Accounting / Processes / Balance Reconsolidation</p></div>
    <div class="row">
        <div class="col-lg-5">
    <form action="../../../controlador/c_files/add_bank.php" method="post" class="form-horizontal">
        <fieldset>
    <legend class="mibread"><strong>Balance Reconsolidation</strong></legend>         

            <div class="form-group">
                  <label class="col-md-4 control-label" for="name">Cambiar Fecha</label>
                  <div class="col-md-8">
