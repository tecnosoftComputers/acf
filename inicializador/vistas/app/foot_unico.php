...
<td><hr>Reviewed by:<br> Identification:</td>
    ...
    <script src="<?php echo PUERTO.'://'.HOST; ?>inicializador/vendor/raphael/raphael.min.js"></script>
    <!--<script src="../../../vendor/morrisjs/morris.min.js"></script>-->
    <script src="<?php echo PUERTO.'://'.HOST; ?>inicializador/data/morris-data.js"></script>
