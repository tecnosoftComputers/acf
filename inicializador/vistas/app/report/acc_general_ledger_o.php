...
<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Accounting / Report / General Ledger Operations</p></div>
    <div class="row">
        <div class="col-lg-6">
    <form action="../../../controlador/c_files/add_bank.php" method="post" class="form-horizontal">
        <fieldset>
        <legend class="mibread"><strong>General Ledger Operations</strong></legend>
            ...
            <div class="form-group">
                  <label class="col-md-4 control-label" for="name">Operación</label>
                  <div class="col-md-8">
                    <input type="text" name="adesde" class="form-control" /> 
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input type="radio" name="adesde" /> Fecha
                    <input type="radio" name="adesde" /> Operación 
                    <input type="radio" name="adesde" /> Empresa
                  </div>
            </div>
