...
<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Accounting / Report / Income Statement Monthly Graph</p></div>
    <div class="row">
        <div class="col-lg-4">
        <form action="../../../controlador/c_files/add_bank.php" method="post" class="form-horizontal">
            <fieldset>
                <legend class="mibread"><strong>Income statement Monthly Graph</strong></legend>
