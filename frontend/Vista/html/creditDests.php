<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Operations / Files / Credit Destinations / <?php echo $type; ?> <a style="float: right; color: #fff" href="<?php echo PUERTO."://".HOST.'/creditDestsList/'; ?>">Volver</a></p></div>
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-5">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="addForm" class="form-horizontal" method="post" action="<?php echo PUERTO."://".HOST.'/'.$view.'/'.Utils::encriptar($rows['CODIGO']).'/'; ?>" onsubmit="return validarFormulario()">
                            ...
                            <fieldset>
                                <legend class="mibread"><strong>Destination</strong></legend>
