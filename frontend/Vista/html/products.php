<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Operations / Files / Products / <?php echo $type; ?> <a style="float: right; color: #fff" href="<?php echo PUERTO."://".HOST.'/productsList/'; ?>">Back</a></p></div>
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-5">
