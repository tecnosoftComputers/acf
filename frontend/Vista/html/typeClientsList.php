<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Operations / Files / System Charts / Customers Status <a style="float: right; color: #fff" href="<?php echo PUERTO."://".HOST.'/systemChartsList/'; ?>">Back</a></p></div>
    <div class="row">
        <div class="col-lg-12">
