<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Operations / Files / Service Classification / <?php echo $type; ?> <a style="float: right; color: #fff" href="<?php echo PUERTO."://".HOST.'/cserviciesList/'; ?>">Back</a></p></div>
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-5">
