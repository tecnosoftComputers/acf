<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Operations / Files / System Charts / Types of calculations <a style="float: right; color: #fff" href="<?php echo PUERTO."://".HOST.'/systemChartsList/'; ?>">Volver</a></p></div>
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body" style="height: 500px; overflow: auto;">
                    ...
                    <div id="export" <?php if($error){ echo 'style="display:none"'; } ?>>
                        <span id="pdf" style="float: right; margin-left: 10px"><a href="<?php echo PUERTO."://".HOST.'/typeCalReport/excel/'; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i></a></span>
                        <span id="excel" style="float: right"><a href="<?php echo PUERTO."://".HOST.'/typeCalReport/pdf/'; ?>" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i></a></span>
                    </div>
                    
                    <ul class="nav nav-pills">
                        <li style="width: auto;" <?php if(!$error){ echo 'class="active"'; } ?>><a id="list" href="#home-pills" data-toggle="tab"><i class="fa fa-th-list"></i> List Types of calculations</a></li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade <?php if(!$error){ echo 'in active'; } ?>" id="home-pills">
                            <br>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="typeCal">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php foreach( (array) $typeCal as $registro2 ){ ?>
                                        <tr class='odd gradeX' data-toggle="collapse" data-target="#demo<?php echo $registro2['CODIGO']; ?>" class="accordion-toggle">
                                            ...
                                            <td align="center"><a href="<?php echo PUERTO."://".HOST.'/typeCalUpdate/'.Utils::encriptar($registro2['CODIGO']).'/'; ?>"><i class="fa fa-edit"></i></a></td>
                                            <td align="center"><a href="<?php echo PUERTO."://".HOST.'/typeCalDelete/'.Utils::encriptar($registro2['CODIGO']).'/'; ?>"><i class="fa fa-trash"></i></a></td>    
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form id="addForm" class="form-horizontal" method="post" action="<?php echo PUERTO."://".HOST.'/'.$view.'/'; ?>" onsubmit="return validarFormulario()">
                                            ...
                                            <fieldset>
                                                <legend class="mibread"><strong>Types of calculations</strong></legend>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <?php if($type == 'Update'){ ?>
                                                        ...
                                                        <span style="float: right"><a href="<?php echo PUERTO."://".HOST.'/typeCalList/'; ?>" class="btn btn-warning"><i class="fa fa-sign-out"></i> Exit</a></span>
                                                        &nbsp;
