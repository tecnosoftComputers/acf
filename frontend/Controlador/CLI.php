      ...
      case 'create': 
        ...
        if(Utils::getParam('create') == 1){
          try{ 
            ...
            $_SESSION['acfSession']['mostrar_exito'] = 'The client was successfully created.';
            $GLOBALS['db']->commit();
          }
          catch(Exception $e){
            $GLOBALS['db']->rollback();
      ...
      case 'update':
        ...
        if(Utils::getParam('save') == 1){
          try{ 
            ...
            $_SESSION['acfSession']['mostrar_exito'] = 'The client was successfully edited.';
            $GLOBALS['db']->commit();
            Utils::doRedirect(PUERTO.'://'.HOST.'/clientsList/');
          }
          catch(Exception $e){
      ...
      case 'delete':
        ...
        if(Utils::getParam('save') == 1){
          try{ 
            ...
            $_SESSION['acfSession']['mostrar_exito'] = 'The client was successfully delete.';
            $GLOBALS['db']->commit();
            Utils::doRedirect(PUERTO.'://'.HOST.'/clientsList/');
          }
          catch(Exception $e){
