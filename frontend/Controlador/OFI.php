<?php
class Controlador_OFI extends Controlador_Base {
  ...
  public function construirPagina(){
    ...
    switch($opcion){
      case 'create': 
        ...
        $tags["template_js"][] = "creditOfficers";
        $tags["template_css"][] = "";

        Vista::render('creditOfficers', $tags);  
      break;
      case 'update':
        ...
        $view = 'creditOfficersUpdate';
        $tags = array('rows'=>$creditOfficers,
                      'type'=>'Update',
                      'view'=>$view);
      ...
      case 'report':
        ...
        $nombre_archivo = 'creditOfficers_List';
        ...
        if($tipo == 'excel'){
          ...
          $objPHPExcel->getProperties()
            ...
            ->setTitle("credit Officers List")
            ->setSubject("credit Officers List")
            ->setCategory("credit Officers List");
          ...
          $objPHPExcel->setActiveSheetIndex(0)
              ->setCellValue('A1', 'CREDIT OFFICERS LIST');
          ...
          foreach ($creditOfficers as $key => $item) {
          ...
          $pdf->Cell(59,5,'CREDIT OFFICERS LIST',0,1);//end of line
          $pdf->Cell(189,10,'',0,1); //end of line
          $pdf->SetFont('Arial','B',12);
          $pdf->Ln(6);
      ...
      default:  
        ...
        $creditOfficers = Modelo_TabGeneral::search($tabla);
        $view = 'creditOfficersCreate'; 
        $tags = array('creditOfficers'=>$creditOfficers,
                      'type'=>'Create',
                      'view'=>$view,
                      'error'=>$error);
        ...
        Vista::render('creditOfficersList', $tags);
      break;
    }
