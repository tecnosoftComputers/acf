! function(t, e) {
    ...
    function Zt(t, e, n) {
        ...
        }), Ot.keydownHandlerAdded = !1), delete Ot.keydownHandler, delete Ot.keydownTarget, t.parentNode && t.parentNode.removeChild(t), ot([document.documentElement, document.body], [k.shown, k["height-auto"], k["no-backdrop"], k["toast-shown"], k["toast-column"]]), at() && (Ut(), zt(), Wt(), Kt())
    }
    ...
    var ae, se = Object.freeze({
        ...
        _main: function(t) {
            ...
            return new Promise(function(t) {
                ...
                Ft.swalPromiseResolve.set(c, t), l.timer && (Ot.timeout = new Gt(function() {
    ...
    }), ue.DismissReason = C, ue.version = "8.11.6";
    var ce = ue;
