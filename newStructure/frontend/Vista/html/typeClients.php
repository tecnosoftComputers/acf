<div id="page-wrapper"><br />
    <div class="alert alert-info"><p>Operations / Files / Customers Status / <?php echo $type; ?> <a style="float: right; color: #fff" href="<?php echo PUERTO."://".HOST.'/typeClientsList/'; ?>">Volver</a></p></div>
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-5">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="addForm" class="form-horizontal" method="post" action="<?php echo PUERTO."://".HOST.'/'.$view.'/'.Utils::encriptar($rows['codtipo']).'/'; ?>" onsubmit="return validarFormulario()">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group" id="seccion_number">
                                    ...
                                    <div class="col-md-2">
                                        <input id="code" name="code" type="text" class="form-control input-sm" maxlength="3" value="<?php echo $rows['codtipo']; ?>" disabled="true" readonly="true" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="seccion_name">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control input-sm" maxlength="30" value="<?php echo $rows['nomtipo']; ?>" <?php if($type == 'Delete'){ echo 'disabled="true" readonly="true"'; } ?>/>
                                    </div>
                                </div>
