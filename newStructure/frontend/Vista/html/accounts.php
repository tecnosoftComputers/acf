...
<div class="alert alert-info"><p>Accounting / Files / Chart Account / <?php echo $type; ?> <a style="float: right; color: #fff" href="<?php echo PUERTO."://".HOST.'/accountsList/'; ?>">Volver</a></p></div>
    <div class="row">
        <div class="col-lg-12">
        <div class="col-lg-7">
