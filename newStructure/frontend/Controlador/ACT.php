      ...
      case 'create': 
        ...
        if(Utils::getParam('create') == 1){
          try{ 
            ...
            $_SESSION['mostrar_exito'] = 'The activity was successfully created.';
            $GLOBALS['db']->commit();
          }
          catch(Exception $e){
            $GLOBALS['db']->rollback();
      ...
      case 'update':
        ...
        if(Utils::getParam('save') == 1){
          try{ 
            ...
            $_SESSION['mostrar_exito'] = 'The activity was successfully edited.';
            $GLOBALS['db']->commit();
            Utils::doRedirect(PUERTO.'://'.HOST.'/activitiesList/');
          }
          catch(Exception $e){
      ...
      case 'delete':
        ...
        if(Utils::getParam('save') == 1){
          try{ 
            ...
            $_SESSION['mostrar_exito'] = 'The activity was successfully delete.';
            $GLOBALS['db']->commit();
            Utils::doRedirect(PUERTO.'://'.HOST.'/activitiesList/');
          }
          catch(Exception $e){
