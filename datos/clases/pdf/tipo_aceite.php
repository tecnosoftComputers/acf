...
$pdf->Cell(59	,5,'LSITADO DE TIPOS DE ACEITE',0,1);//end of line
...
$pdf->Cell(10	,5,'#',1,0);
$pdf->Cell(80	,5,'TIPO DE ACEITE',1,0);
$pdf->Cell(40	,5,'FECHA REGISTRO',1,0);
$pdf->Cell(45	,5,'FECHA MODIFICACION',1,0);
$pdf->Cell(189	,10,'',0,1);//end of line
$pdf->SetFont('Arial','',14);

$query = mysqli_query($con,"SELECT * FROM c_tipo_aceite WHERE estado = 'A'");

while($item = mysqli_fetch_array($query)){
	$pdf->SetFont('Arial','',8);
    $pdf->Cell(10	,5,$item['id_tipo_aceite'],0,0);
	$pdf->Cell(80	,5,$item['nombreaceite'],0,0);
