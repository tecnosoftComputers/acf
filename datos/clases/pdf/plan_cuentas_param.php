...
$pdf->Cell(59	,5,'CHART ACCOUNT',0,1);//end of line
$pdf->SetFont('Arial','',12);
$pdf->Cell(189	,10,'',0,1); //end of line
$pdf->Cell(12	,5,'Date:',0,0);$pdf->Cell(58	,5,date('y-m-d'),0,0);
$pdf->Cell(189	,10,'',0,1); //end of line
$pdf->SetFont('Arial','',10);

$pdf->Cell(189	,10,'',0,1); //end of line
$pdf->SetFont('Arial','B',11);
$pdf->Cell(80	,5,'NUMBER ACCOUNT',1,0);
$pdf->Cell(100	,5,'NAME ACCOUNT',1,0);
$pdf->Cell(189	,10,'',0,1); //end of line
$pdf->SetFont('Arial','',28);

$query = mysqli_query($con,"SELECT * FROM dp01a110 WHERE CODIGO_AUX='$param'");
while($item = mysqli_fetch_array($query)){
    $var = substr($item['CODIGO'], -1);
    if ($var == '.') {
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(80	,5,$item['CODIGO'],0,0);
