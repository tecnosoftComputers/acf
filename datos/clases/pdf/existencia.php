...
$pdf->Cell(59	,5,'EXISTENCIA DE MERCADERIA',0,1);//end of line
...
$pdf->Cell(120	,5,'NOMBRE PRODUCTO',1,0);
$pdf->Cell(80	,5,'STOCK',1,0);
$pdf->Cell(189	,10,'',0,1);//end of line
$pdf->SetFont('Arial','',14);

$query = mysqli_query($con,"SELECT distinct(codproducto), nombreproducto, existencia FROM c_mercaderia WHERE estado = 'A' ORDER BY codproducto ASC");

while($item = mysqli_fetch_array($query)){
	$pdf->SetFont('Arial','',9);
    $pdf->Cell(60	,5,$item['codproducto'],0,0);
	$pdf->Cell(120	,5,$item['nombreproducto'],0,0);
    $pdf->Cell(80	,5,$item['existencia'],0,0);
