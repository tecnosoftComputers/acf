<?php
	...
	//Consulta
	$sql = "SELECT nombre, fecha_registro, observacion FROM c_categoria WHERE estado='A'";
	...
	$objPHPExcel->getProperties()->setCreator("Fernando Reyes")->setDescription("Reporte de Categoria de Productos");
	
	//Establecemos la pestaña activa y nombre a la pestaña
	$objPHPExcel->setActiveSheetIndex(0);
	$objPHPExcel->getActiveSheet()->setTitle("c_categorias");
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B3', 'REPORTE DE CATEGORIA DE PRODUCTOS');
