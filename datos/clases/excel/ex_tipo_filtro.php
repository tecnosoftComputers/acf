<?php
	...
	//Consulta
	$sql = "SELECT nombrefiltro, fecha_registro, observacion FROM c_tipo_filtro WHERE estado='A'";
	...
	$objPHPExcel->getProperties()->setCreator("Fernando Reyes")->setDescription("Reporte de Tipo de Filtro");
	
	//Establecemos la pestaña activa y nombre a la pestaña
	$objPHPExcel->setActiveSheetIndex(0);
	$objPHPExcel->getActiveSheet()->setTitle("c_tipo_filtro");
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B3', 'REPORTE DE TIPO DE FILTRO');
	...
	while($rows = $resultado->fetch_assoc()){
		$objPHPExcel->getActiveSheet()->setCellValue('A'.$fila, $rows['nombrefiltro']);
	...
	$values = new PHPExcel_Chart_DataSeriesValues('Number', 'Filtro!$D$7:$D$'.$fila);
	
	// definir origen de los rotulos
	$categories = new PHPExcel_Chart_DataSeriesValues('String', 'Filtro!$B$7:$B$'.$fila);
